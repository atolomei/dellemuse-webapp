...
//@WicketSignInPage
@MountPath("forgot")
public class DellemuseWebForgotPasswordPage extends BasePage {

	private static final long serialVersionUID = 1L;
	
    static private Logger logger = Logger.getLogger(DellemuseWebForgotPasswordPage.class.getName());
    ...
    public DellemuseWebForgotPasswordPage() {
            this(null);
    }
    
	public DellemuseWebForgotPasswordPage(PageParameters parameters) {
		super(parameters);
		//
	...
	public void onInitialize() {
	        ...
	        SubmitButton<Void> submit = new SubmitButton<Void>("submit") {
                ...
                protected void onSubmit(AjaxRequestTarget target) {
                    DellemuseWebForgotPasswordPage.this.onSubmit();
                }
	        };
	        form.add(submit);
	}
    ...
    protected void onSubmit() {
    	...
    	this.email=emailField.getValue();
